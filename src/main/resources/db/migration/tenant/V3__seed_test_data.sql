...
-- Terminals (단말기)
-- =============================================================================
INSERT INTO terminals (id, tid, cat_id, terminal_type, merchant_id, organization_id, serial_number, model, manufacturer, install_address, install_date, status) VALUES
('01960000-0000-7000-0005-000000000001', 'TID001', 'CAT001', 'CAT', '01960000-0000-7000-0003-000000000001', '01960000-0000-7000-0001-000000000008', 'SN001', 'KP-100', 'KORPAY', '서울시 강남구 역삼동 123', '2024-01-15', 'ACTIVE'),
('01960000-0000-7000-0005-000000000002', 'TID002', 'CAT002', 'POS', '01960000-0000-7000-0003-000000000002', '01960000-0000-7000-0001-000000000009', 'SN002', 'KP-200', 'KORPAY', '서울시 강남구 삼성동 456', '2024-02-10', 'ACTIVE'),
('01960000-0000-7000-0005-000000000003', 'TID003', 'CAT003', 'KIOSK', '01960000-0000-7000-0003-000000000003', '01960000-0000-7000-0001-000000000010', 'SN003', 'KP-300', 'KORPAY', '서울시 서초구 반포대로 789', '2024-03-05', 'ACTIVE'),
('01960000-0000-7000-0005-000000000004', 'TID004', NULL, 'ONLINE', '01960000-0000-7000-0003-000000000003', '01960000-0000-7000-0001-000000000010', 'SN004', 'ONLINE', 'KORPAY', NULL, '2024-03-05', 'ACTIVE');
